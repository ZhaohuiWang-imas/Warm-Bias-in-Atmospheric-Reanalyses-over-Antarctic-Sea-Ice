...
for i=1:length(x0)
   ...
   % add cloud mask here
   cloud_JRA55=ncread('/Volumes/PostDoc_drive/JRA55_cloud_LHM/JRA55_HCF_polargrid.nc','HCDC_GDS4_ISBY',[1 1 1 16118+4*(i-1)],[Inf Inf Inf 4]);
...
for i=1:length(x0)
   ...
   data_JRA55(data_JRA55==0)=nan;
   % add cloud mask here
   cloud_JRA55=ncread('/Volumes/PostDoc_drive/JRA55_cloud_LHM/JRA55_MCF_polargrid.nc','MCDC_GDS4_ISBY',[1 1 1 16118+4*(i-1)],[Inf Inf Inf 4]);
   cloud_JRA55=permute(cloud_JRA55,[2 1 3 4]);
   cloud_JRA55=reshape(cloud_JRA55,[332,316,8]);
   data_JRA55(cloud_JRA55>20)=nan;
   for fr=1:8
