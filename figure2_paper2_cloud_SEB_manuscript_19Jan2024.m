...
Y=[ERA5_dlwrf_season_domain,ERA5_dlwrf_season_domain,ERA5_dlwrf_season_domain-ERA5_dlwrf_season_domain_allsky;
       ERA5_ulwrf_season_domain,ERA5_ulwrf_season_domain_allsky,ERA5_ulwrf_season_domain-ERA5_ulwrf_season_domain_allsky;
       ERA5_lhf_season_domain,ERA5_lhf_season_domain_allsky,ERA5_lhf_season_domain-ERA5_lhf_season_domain_allsky;
       ERA5_shf_season_domain,ERA5_shf_season_domain_allsky,ERA5_shf_season_domain-ERA5_shf_season_domain_allsky;
       ERA5_dswrf_season_domain,ERA5_dswrf_season_domain_allsky,ERA5_dswrf_season_domain-ERA5_dswrf_season_domain_allsky;
...
% ERA5_cloud_figure=ERA5_ME_masked{1}; JRA55_cloud_figure=JRA55_ME_masked{1};
% Corr_ERA5_JRA55=Corr1;
% cd  /Users/zhaohuiw/Documents/GitHub/IST_bias_paper_data
% % 将所有变量保存到Figure2.mat文件中
% save('Figure2.mat', 'ERA5_cloud_figure', 'JRA55_cloud_figure', 'Corr_ERA5_JRA55', ...
%      'ERA5_dlwrf_season_domain', 'ERA5_dlwrf_season_domain_allsky', ...
%      'ERA5_ulwrf_season_domain', 'ERA5_ulwrf_season_domain_allsky', ...
%      'ERA5_lhf_season_domain', 'ERA5_lhf_season_domain_allsky', ...
%      'ERA5_shf_season_domain', 'ERA5_shf_season_domain_allsky', ...
%      'ERA5_dswrf_season_domain', 'ERA5_dswrf_season_domain_allsky', ...
%      'ERA5_uswrf_season_domain', 'ERA5_uswrf_season_domain_allsky', ...
%      'JRA55_dlwrf_season_domain', 'JRA55_dlwrf_season_domain_allsky', ...
%      'JRA55_ulwrf_season_domain', 'JRA55_ulwrf_season_domain_allsky', ...
%      'JRA55_lhf_season_domain', 'JRA55_lhf_season_domain_allsky', ...
%      'JRA55_shf_season_domain', 'JRA55_shf_season_domain_allsky', ...
%      'JRA55_dswrf_season_domain', 'JRA55_dswrf_season_domain_allsky', ...
%      'JRA55_uswrf_season_domain', 'JRA55_uswrf_season_domain_allsky');
