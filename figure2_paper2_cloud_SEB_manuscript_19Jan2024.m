...
q=1;
    ...
    for j=1:2
        ...
        m_contourf(lons,lats,Corr(:,:,j), -1:0.1:1,'LineStyle','None');
        m_grid('tickdir','in','xtick',-180:60:180,'ytick',-80:10:-60,'fontsize',16,'tickdir','in','xticklabel','','yticklabel','','box','fancy');
        hold on
        a=pvalue(:,:,j);
        [a3 a4]=find(a>0.05);
...
m_proj('azimuthal equal-area','latitude',-87,'longitude',3,'radius',47,'rectbox','on');
m_contourf(lons,lats,Corr(:,:,1), -1:0.1:1,'LineStyle','None');
m_grid('tickdir','in','xtick',-180:60:180,'ytick',-80:10:-60,'fontsize',16,'tickdir','in','xticklabel','','yticklabel','','box','fancy');
hold on
a=pvalue(:,:,1);
[a3 a4]=find(a>0.05);
...
m_proj('azimuthal equal-area','latitude',-87,'longitude',3,'radius',47,'rectbox','on');
m_contourf(lons,lats,Corr(:,:,2), -1:0.1:1,'LineStyle','None');
m_grid('tickdir','in','xtick',-180:60:180,'ytick',-80:10:-60,'fontsize',16,'tickdir','in','xticklabel','','yticklabel','','box','fancy');
hold on
a=pvalue(:,:,2);
[a3 a4]=find(a>0.05);
